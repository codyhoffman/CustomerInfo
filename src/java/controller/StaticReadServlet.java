...
import dbHelpers.StaticReadQuery;
 ...
 * @author codyhoffman
 */
@WebServlet(name = "StaticRead", urlPatterns = {"/staticRead"})
public class StaticReadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        StaticReadQuery rq = new StaticReadQuery();
